...
# valores por donde comenzar a ajustar.
            ...
            # pide el paquete de regresión lineal
                ...
                if p1_01[0] < 0:
                    ...
                    s_env01 = s_env01[:len(lapsetime01)]
                    
            if p1_01[0] > 0:
                print("No hay pendiente negativa")
            
            cut_prediccion01 = prediccion01[:len(lapsetime01)]
            cut_Alpt01 = Alpt01[:len(lapsetime01)]
            cut_cut_env01 = cut_env01[:len(lapsetime01)]
            cut_logAlpt01 = logAlpt01[:len(lapsetime01)]

            plt.figure(1)
            plt.plot(lapsetime01,cut_prediccion01, label="Alpt = {:.4f}t + {:.4f}".format(p1_01[0],p2_01))
            #plt.plot(lapsetime01,cut_Alpt01, label="exponencial corregida por div geom")
            plt.plot(lapsetime01,cut_logAlpt01, label="logaritmo de la amplitud")
            #plt.plot(lapsetime01,cut_cut_env01, label="envolvente de la coda")
            plt.xlabel("tiempo [seg]")
            ...
            while len(lapsetime02) > 30*50:
                ...
                #print("Resultados del ajuste lineal. Frecuencias entre 1.0 - 2.0 Hz")
                #print(f"coefficient of determination: {r_sq02}")
                p2_02 = model02.intercept_
                #print("intersección: {:.4f}".format(p2_02))
                p1_02 = model02.coef_
                #print("pendiente: {:.4f}. len(lapsetime02)={:}".format(p1_02[0],len(lapsetime02)))
                ...
                if p1_02[0] < 0:
                    ...
                    #print("pendiente: {:.4f}. len(lapsetime02)={:}".format(p1_02[0],len(lapsetime02)))
                    lapsetime02 = lapsetime02[:len(lapsetime02)-500]
                    s_env02 = s_env02[:len(lapsetime02)]
            
            if p1_02[0] > 0:
                print("No hay pendiente negativa")
            
            cut_prediccion02 = prediccion02[:len(lapsetime02)]
            cut_Alpt02 = Alpt02[:len(lapsetime02)]
            cut_cut_env02 = cut_env02[:len(lapsetime02)]
            cut_logAlpt02 = logAlpt02[:len(lapsetime02)]            

            plt.figure(2)
            plt.plot(lapsetime02,cut_prediccion02, label="Alpt = {:.4f}t + {:.4f}".format(p1_02[0],p2_02))
            #plt.plot(lapsetime02,cut_Alpt02, label="exponencial corregida por div geom")
            plt.plot(lapsetime02,cut_logAlpt02, label="logaritmo de la amplitud")
            #plt.plot(lapsetime02,cut_cut_env02, label="envolvente de la coda")
            plt.xlabel("tiempo [seg]")
            plt.ylabel("ln(Alpt)")
            ...
            while len(lapsetime03) > 30*50:
                ...
                #print("Resultados del ajuste lineal. Frecuencias entre 1.5 - 2.5 Hz")
                #print(f"coefficient of determination: {r_sq03}")
                p2_03 = model03.intercept_
                #print("intersección: {:.4f}".format(p2_03))
                p1_03 = model03.coef_
                #print("pendiente: {:.4f}. len(lapsetime03)={:}".format(p1_03[0],len(lapsetime03)))
                ...
                if p1_03[0] < 0:
                    ...
                    #print("pendiente: {:.4f}. len(lapsetime03)={:}".format(p1_03[0],len(lapsetime03)))
                    lapsetime03 = lapsetime03[:len(lapsetime03)-500]
                    s_env03 = s_env03[:len(lapsetime03)]
            
            if p1_03[0] > 0:
                print("No hay pendiente negativa")            
            
            cut_prediccion03 = prediccion03[:len(lapsetime03)]
            cut_Alpt03 = Alpt03[:len(lapsetime03)]
            cut_cut_env03 = cut_env03[:len(lapsetime03)]
            cut_logAlpt03 = logAlpt03[:len(lapsetime03)]            

            plt.figure(3)
            plt.plot(lapsetime03,cut_prediccion03, label="Alpt = {:.4f}t + {:.4f}".format(p1_03[0],p2_03))
            #plt.plot(lapsetime03,cut_Alpt03, label="exponencial corregida por div geom")
            plt.plot(lapsetime03,cut_logAlpt03, label="logaritmo de la amplitud")
            #plt.plot(lapsetime03,cut_cut_env03, label="envolvente de la coda")
            plt.xlabel("tiempo [seg]")
            plt.ylabel("ln(Alpt)")
            ...
            while len(lapsetime04) > 30*50:
                ...
                #print("Resultados del ajuste lineal. Frecuencias entre 2.0 - 3.0 Hz")
                #print(f"coefficient of determination: {r_sq04}")
                p2_04 = model04.intercept_
                #print("intersección: {:.4f}".format(p2_04))
                p1_04 = model04.coef_
                #print("pendiente: {:.4f}. len(lapsetime04)={:}".format(p1_04[0],len(lapsetime04)))
                ...
                if p1_04[0] < 0:
                    ...
                    #print("pendiente: {:.4f}. len(lapsetime04)={:}".format(p1_04[0],len(lapsetime04)))
                    lapsetime04 = lapsetime04[:len(lapsetime04)-500]
                    s_env04 = s_env04[:len(lapsetime04)]
            
            if p1_04[0] > 0:
                print("No hay pendiente negativa")                        
            
            cut_prediccion04 = prediccion04[:len(lapsetime04)]
            cut_Alpt04 = Alpt04[:len(lapsetime04)]
            cut_cut_env04 = cut_env04[:len(lapsetime04)]
            cut_logAlpt04 = logAlpt04[:len(lapsetime04)]            

            plt.figure(4)
            plt.plot(lapsetime04,cut_prediccion04, label="Alpt = {:.4f}t + {:.4f}".format(p1_04[0],p2_04))
            #plt.plot(lapsetime04,cut_Alpt04, label="exponencial corregida por div geom")
            plt.plot(lapsetime04,cut_logAlpt04, label="logaritmo de la amplitud")
            #plt.plot(lapsetime04,cut_cut_env04, label="envolvente de la coda")
            plt.xlabel("tiempo [seg]")
            plt.ylabel("ln(Alpt)")
            ...
            while len(lapsetime05) > 30*50:
                ...
                #print("Resultados del ajuste lineal. Frecuencias entre 2.5 - 3.5 Hz")
                #print(f"coefficient of determination: {r_sq05}")
                p2_05 = model05.intercept_
                #print("intersección: {:.4f}".format(p2_05))
                p1_05 = model05.coef_
                #print("pendiente: {:.4f}. len(lapsetime05)={:}".format(p1_05[0],len(lapsetime05)))
                ...
                if p1_05[0] < 0:
                    ...
                    #print("pendiente: {:.4f}. len(lapsetime05)={:}".format(p1_05[0],len(lapsetime05)))
                    lapsetime05 = lapsetime05[:len(lapsetime05)-500]
                    s_env05 = s_env05[:len(lapsetime05)]
            
            if p1_05[0] > 0:
                print("No hay pendiente negativa")                        

            cut_prediccion05 = prediccion05[:len(lapsetime05)]
            cut_Alpt05 = Alpt05[:len(lapsetime05)]
            cut_cut_env05 = cut_env05[:len(lapsetime05)]
            cut_logAlpt05 = logAlpt05[:len(lapsetime05)]            

            plt.figure(5)
            plt.plot(lapsetime05,cut_prediccion05, label="Alpt = {:.4f}t + {:.4f}".format(p1_05[0],p2_05))
            #plt.plot(lapsetime05,cut_Alpt05, label="exponencial corregida por div geom")
            plt.plot(lapsetime05,cut_logAlpt05, label="logaritmo de la amplitud")
            #plt.plot(lapsetime05,cut_cut_env05, label="envolvente de la coda")
            plt.xlabel("tiempo [seg]")
            plt.ylabel("ln(Alpt)")
            ...
            while len(lapsetime06) > 30*50:
                ...
                #print("Resultados del ajuste lineal. Frecuencias entre 3.0 - 4.0 Hz")
                #print(f"coefficient of determination: {r_sq06}")
                p2_06 = model06.intercept_
                #print("intersección: {:.4f}".format(p2_06))
                p1_06 = model06.coef_
                #print("pendiente: {:.4f}. len(lapsetime06)={:}".format(p1_06[0],len(lapsetime06)))
                ...
                if p1_06[0] < 0:
                    ...
                    #print("pendiente: {:.4f}. len(lapsetime06)={:}".format(p1_06[0],len(lapsetime06)))
                    lapsetime06 = lapsetime06[:len(lapsetime06)-500]
                    s_env06 = s_env06[:len(lapsetime06)]
            
            if p1_06[0] > 0:
                print("No hay pendiente negativa")                        

            cut_prediccion06 = prediccion06[:len(lapsetime06)]
            cut_Alpt06 = Alpt06[:len(lapsetime06)]
            cut_cut_env06 = cut_env06[:len(lapsetime06)]
            cut_logAlpt06 = logAlpt06[:len(lapsetime06)]            

            plt.figure(6)
            plt.plot(lapsetime06,cut_prediccion06, label="Alpt = {:.4f}t + {:.4f}".format(p1_06[0],p2_06))
            #plt.plot(lapsetime06,cut_Alpt06, label="exponencial corregida por div geom")
            plt.plot(lapsetime06,cut_logAlpt06, label="logaritmo de la amplitud")
            #plt.plot(lapsetime06,cut_cut_env06, label="envolvente de la coda")
            plt.xlabel("tiempo [seg]")
            plt.ylabel("ln(Alpt)")
            ...
            while len(lapsetime07) > 30*50:
                ...
                #print("Resultados del ajuste lineal. Frecuencias entre 3.5 - 4.5 Hz")
                #print(f"coefficient of determination: {r_sq07}")
                p2_07 = model07.intercept_
                #print("intersección: {:.4f}".format(p2_07))
                p1_07 = model07.coef_
                #print("pendiente: {:.4f}. len(lapsetime07)={:}".format(p1_07[0],len(lapsetime07)))
                ...
                if p1_07[0] < 0:
                    ...
                    #print("pendiente: {:.4f}. len(lapsetime07)={:}".format(p1_07[0],len(lapsetime07)))
                    lapsetime07 = lapsetime07[:len(lapsetime07)-500]
                    s_env07 = s_env07[:len(lapsetime07)]
            
            if p1_07[0] > 0:
                print("No hay pendiente negativa")                        

            cut_prediccion07 = prediccion07[:len(lapsetime07)]
            cut_Alpt07 = Alpt07[:len(lapsetime07)]
            cut_cut_env07 = cut_env07[:len(lapsetime07)]
            cut_logAlpt07 = logAlpt07[:len(lapsetime07)]            

            plt.figure(7)
            plt.plot(lapsetime07,cut_prediccion07, label="Alpt = {:.4f}t + {:.4f}".format(p1_07[0],p2_07))
            #plt.plot(lapsetime07,cut_Alpt07, label="exponencial corregida por div geom")
            plt.plot(lapsetime07,cut_logAlpt07, label="logaritmo de la amplitud")
            #plt.plot(lapsetime07,cut_cut_env07, label="envolvente de la coda")
            plt.xlabel("tiempo [seg]")
            plt.ylabel("ln(Alpt)")
            ...
            while len(lapsetime08) > 30*50:
                ...
                #print("Resultados del ajuste lineal. Frecuencias entre 4.0 - 5.0 Hz")
                #print(f"coefficient of determination: {r_sq08}")
                p2_08 = model08.intercept_
                #print("intersección: {:.4f}".format(p2_08))
                p1_08 = model08.coef_
                #print("pendiente: {:.4f}. len(lapsetime08)={:}".format(p1_08[0],len(lapsetime08)))
                ...
                if p1_08[0] < 0:
                    ...
                    #print("pendiente: {:.4f}. len(lapsetime08)={:}".format(p1_08[0],len(lapsetime08)))
                    lapsetime08 = lapsetime08[:len(lapsetime08)-500]
                    s_env08 = s_env08[:len(lapsetime08)]
            
            if p1_08[0] > 0:
                print("No hay pendiente negativa")                        

            cut_prediccion08 = prediccion08[:len(lapsetime08)]
            cut_Alpt08 = Alpt08[:len(lapsetime08)]
            cut_cut_env08 = cut_env08[:len(lapsetime08)]
            cut_logAlpt08 = logAlpt08[:len(lapsetime08)]            

            plt.figure(8)
            plt.plot(lapsetime08,cut_prediccion08, label="Alpt = {:.4f}t + {:.4f}".format(p1_08[0],p2_08))
            #plt.plot(lapsetime08,cut_Alpt08, label="exponencial corregida por div geom")
            plt.plot(lapsetime08,cut_logAlpt08, label="logaritmo de la amplitud")
            #plt.plot(lapsetime08,cut_cut_env08, label="envolvente de la coda")
            plt.xlabel("tiempo [seg]")
            plt.ylabel("ln(Alpt)")
            plt.title("Ajuste lineal - Frecuencias entre 3.5 - 4.5 Hz")
            plt.legend()  
...
# el ajuste lineal
            ...
            if p1_01[0] < 0:
                ...
                # ajuste
                popt_01, pcov_01 = curve_fit(model_exp, lapsetime01, Alpt01, p0_01)
                Q_01 = -np.pi*1/popt_01[1]
                print("Q para frecuencias entre 0.5 y 1.5 Hz: {:.4f}".format(Q_01))
            
            elif p1_01[0] > 0:
                Q_01 = 0
                print("No se puede calcular Q para freciencias entre 0.5 y 1.5 Hz")
            ...
            if p1_02[0] < 0:
                ...
                popt_02, pcov_02 = curve_fit(model_exp, lapsetime02, Alpt02, p0_02)
                Q_02 = -np.pi*1/popt_02[1]
                print("Q para frecuencias entre 1.0 y 2.0 Hz: {:.4f}".format(Q_02))
            
            elif p1_02[0] > 0:
                Q_02 = 0
                print("No se puede calcular Q para freciencias entre 1.0 y 2.0 Hz")
            ...
            if p1_03[0] < 0:
                ...
                popt_03, pcov_03 = curve_fit(model_exp, lapsetime03, Alpt03, p0_03)
                Q_03 = -np.pi*1/popt_03[1]
                print("Q para frecuencias entre 1.5 y 2.5 Hz: {:.4f}".format(Q_03))
            
            elif p1_03[0] > 0:
                Q_03 = 0
                print("No se puede calcular Q para freciencias entre 1.5 y 2.5 Hz")
            ...
            if p1_04[0] < 0:
                ...
                popt_04, pcov_04 = curve_fit(model_exp, lapsetime04, Alpt04, p0_04)
                Q_04 = -np.pi*1/popt_04[1]
                print("Q para frecuencias entre 2.0 y 3.0 Hz: {:.4f}".format(Q_04))
            
            elif p1_04[0] > 0:
                Q_04 = 0
                print("No se puede calcular Q para freciencias entre 2.0 y 3.0 Hz")
            ...
            if p1_05[0] < 0:
                ...
                popt_05, pcov_05 = curve_fit(model_exp, lapsetime05, Alpt05, p0_05)
                Q_05 = -np.pi*1/popt_05[1]
                print("Q para frecuencias entre 2.5 y 3.5 Hz: {:.4f}".format(Q_05))
            
            elif p1_05[0] > 0:
                Q_05 = 0
                print("No se puede calcular Q para freciencias entre 2.5 y 3.5 Hz")
            ...
            if p1_06[0] < 0:
                ...
                popt_06, pcov_06 = curve_fit(model_exp, lapsetime06, Alpt06, p0_06)
                Q_06 = -np.pi*1/popt_06[1]
                print("Q para frecuencias entre 3.0 y 4.0 Hz: {:.4f}".format(Q_06))
            
            elif p1_06[0] > 0:
                Q_06 = 0
                print("No se puede calcular Q para freciencias entre 3.0 y 4.0 Hz")
            
            # ----------------------------
            # 07
            if p1_07[0] < 0:
                p0_07 = (np.exp(p2_07),p1_07[0])
                popt_07, pcov_07 = curve_fit(model_exp, lapsetime07, Alpt07, p0_07)
                Q_07 = -np.pi*1/popt_07[1]
                print("Q para frecuencias entre 3.5 y 4.5 Hz: {:.4f}".format(Q_07))
            
            elif p1_07[0] > 0:
                Q_07 = 0
                print("No se puede calcular Q para freciencias entre 3.5 y 4.5 Hz")

            # ----------------------------
            # 08
            if p1_08[0] < 0:
                p0_08 = (np.exp(p2_08),p1_08[0])
                popt_08, pcov_08 = curve_fit(model_exp, lapsetime08, Alpt08, p0_08)
                Q_08 = -np.pi*1/popt_08[1]
                print("Q para frecuencias entre 4.0 y 5.0 Hz: {:.4f}".format(Q_08))
            
            elif p1_08[0] > 0:
                Q_08 = 0
                print("No se puede calcular Q para freciencias entre 4.0 y 5.0 Hz")
...
#-----------------------------------------------------------------------------
            ...
            # 01
            if p1_01[0] < 0:
                p0_01_d = (np.exp(p2_01),-p1_01[0],0)
                popt_01_d, pcov_01_d = curve_fit(model_dif, lapsetime01, np.log(Alpt01), p0_01_d)
                
                Qi_01 = 2*np.pi*(w1+w2)/(2*popt_01_d[1])
                d_01 = dist**2/(4*popt_01_d[2])
                Qs_01 = np.pi*(w1+w2)*p*d_01/vel**2
                print("Qi={:.4f} y Qs={:.4f} para frecuencias entre 0.5 y 1.5 Hz".format(Qi_01,Qs_01))
            
            elif p1_01[0] > 0:
                Qi_01 = 0
                Qs_01 = 0
                print("No se puede calcular Qi ni Qs para frecuencias entre 0.5 y 1.5 Hz")


            # ----------------------------
            # 02
            if p1_02[0] < 0:
                p0_02_d = (np.exp(p2_02),-p1_02[0],0)
                popt_02_d, pcov_02_d = curve_fit(model_dif, lapsetime02, np.log(Alpt02), p0_02_d)
            
                Qi_02 = 2*np.pi*(w3+w4)/(2*popt_02_d[1])
                d_02 = dist**2/(4*popt_02_d[2])
                Qs_02 = np.pi*(w3+w4)*p*d_02/vel**2
                print("Qi={:.4f} y Qs={:.4f} para frecuencias entre 1.0 y 2.0 Hz".format(Qi_02,Qs_02))
            
            elif p1_02[0] > 0:
                Qi_02 = 0
                Qs_02 = 0
                print("No se puede calcular Qi ni Qs para frecuencias entre 1.0 y 2.0 Hz")


            # ----------------------------
            # 03
            if p1_03[0] < 0:
                p0_03_d = (np.exp(p2_03),-p1_03[0],0)
                popt_03_d, pcov_03_d = curve_fit(model_dif, lapsetime03, np.log(Alpt03), p0_03_d)
                
                Qi_03 = 2*np.pi*(w5+w6)/(2*popt_03_d[1])
                d_03 = dist**2/(4*popt_03_d[2])
                Qs_03 = np.pi*(w5+w6)*p*d_03/vel**2
                print("Qi={:.4f} y Qs={:.4f} para frecuencias entre 1.5 y 2.5 Hz".format(Qi_03,Qs_03))
            
            elif p1_03[0] > 0:
                Qi_03 = 0
                Qs_03 = 0
                print("No se puede calcular Qi ni Qs para frecuencias entre 1.5 y 2.5 Hz")


            # ----------------------------
            # 04
            if p1_04[0] < 0:
                p0_04_d = (np.exp(p2_04),-p1_04[0],0)
                popt_04_d, pcov_04_d = curve_fit(model_dif, lapsetime04, np.log(Alpt04), p0_04_d)
                
                Qi_04 = 2*np.pi*(w7+w8)/(2*popt_04_d[1])
                d_04 = dist**2/(4*popt_04_d[2])
                Qs_04 = np.pi*(w7+w8)*p*d_04/vel**2
                print("Qi={:.4f} y Qs={:.4f} para frecuencias entre 2.0 y 3.0 Hz".format(Qi_04,Qs_04))
            
            elif p1_04[0] > 0:
                Qi_04 = 0
                Qs_04 = 0
                print("No se puede calcular Qi ni Qs para frecuencias entre 2.0 y 3.0 Hz")


            # ----------------------------
            # 05
            if p1_05[0] < 0:
                p0_05_d = (np.exp(p2_05),-p1_05[0],0)
                popt_05_d, pcov_05_d = curve_fit(model_dif, lapsetime05, np.log(Alpt05), p0_05_d)
                
                Qi_05 = 2*np.pi*(w9+w10)/(2*popt_05_d[1])
                d_05 = dist**2/(4*popt_05_d[2])
                Qs_05 = np.pi*(w9+w10)*p*d_05/vel**2
                print("Qi={:.4f} y Qs={:.4f} para frecuencias entre 2.5 y 3.5 Hz".format(Qi_05,Qs_05))
            
            elif p1_05[0] > 0:
                Qi_05 = 0
                Qs_05 = 0
                print("No se puede calcular Qi ni Qs para frecuencias entre 2.5 y 3.5 Hz")

            
            # ----------------------------
            # 06
            if p1_06[0] < 0:
                p0_06_d = (np.exp(p2_06),-p1_06[0],0)
                popt_06_d, pcov_06_d = curve_fit(model_dif, lapsetime06, np.log(Alpt06), p0_06_d)
                
                Qi_06 = 2*np.pi*(w11+w12)/(2*popt_06_d[1])
                d_06 = dist**2/(4*popt_06_d[2])
                Qs_06 = np.pi*(w11+w12)*p*d_06/vel**2
                print("Qi={:.4f} y Qs={:.4f} para frecuencias entre 3.0 y 4.0 Hz".format(Qi_06,Qs_06))
            
            elif p1_06[0] > 0:
                Qi_06 = 0
                Qs_06 = 0
                print("No se puede calcular Qi ni Qs para frecuencias entre 3.0 y 4.0 Hz")


            # ----------------------------
            # 07
            if p1_07[0] < 0:
                p0_07_d = (np.exp(p2_07),-p1_07[0],0)
                popt_07_d, pcov_07_d = curve_fit(model_dif, lapsetime07, np.log(Alpt07), p0_07_d)
                
                Qi_07 = 2*np.pi*(w13+w14)/(2*popt_07_d[1])
                d_07 = dist**2/(4*popt_07_d[2])
                Qs_07 = np.pi*(w13+w14)*p*d_07/vel**2
                print("Qi={:.4f} y Qs={:.4f} para frecuencias entre 3.5 y 4.5 Hz".format(Qi_07,Qs_07))
            
            elif p1_07[0] > 0:
                Qi_07 = 0
                Qs_07 = 0
                print("No se puede calcular Qi ni Qs para frecuencias entre 3.5 y 4.5 Hz")


            # ----------------------------
            # 08
            if p1_08[0] < 0:
                p0_08_d = (np.exp(p2_08),-p1_08[0],0)
                popt_08_d, pcov_08_d = curve_fit(model_dif, lapsetime08, np.log(Alpt08), p0_08_d)
                
                Qi_08 = 2*np.pi*(w15+w16)/(2*popt_08_d[1])
                d_08 = dist**2/(4*popt_08_d[2])
                Qs_08 = np.pi*(w15+w16)*p*d_08/vel**2
                print("Qi={:.4f} y Qs={:.4f} para frecuencias entre 4.0 y 5.0 Hz".format(Qi_08,Qs_08))
            
            elif p1_08[0] > 0:
                Qi_08 = 0
                Qs_08 = 0
                print("No se puede calcular Qi ni Qs para frecuencias entre 4.0 y 5.0 Hz")
