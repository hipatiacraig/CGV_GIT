...
# valores por donde comenzar a ajustar.
            ...
            logAlpt01 = np.log(pAlpt01).reshape(-1)
            ...
            p1_01 = model01.coef_
            print("intersección: {:.4f}".format(p1_01[0]))

            plt.figure(1)
            plt.plot(lapsetime01,prediccion01, label="Alpt = {:.4f}t + {:.4f}".format(p1_01[0],p2_01))
            plt.plot(lapsetime01,pAlpt01, label="exponencial corregida por div geom")
            plt.plot(lapsetime01,cut_env01, label="envolvente de la coda")
            plt.xlabel("tiempo [seg]")
            plt.ylabel("amplitud corregida por div geom (Alpt)")
            ...
            # ----------------------------
            # 02
            logAlpt02 = np.log(pAlpt02).reshape(-1)
            ...
            p1_02 = model02.coef_
            print("intersección: {:.4f}".format(p1_02[0]))

            plt.figure(2)
            plt.plot(lapsetime02,prediccion02, label="Alpt = {:.4f}t + {:.4f}".format(p1_02[0],p2_02))
            plt.plot(lapsetime02,pAlpt02, label="exponencial corregida por div geom")
            plt.plot(lapsetime02,cut_env02, label="envolvente de la coda")
            plt.xlabel("tiempo [seg]")
            plt.ylabel("amplitud corregida por div geom (Alpt)")
            plt.title("Frecuencias entre 1.0 - 2.0 Hz")
            plt.legend()   
            
            
            # ----------------------------
            # 03
            logAlpt03 = np.log(pAlpt03).reshape(-1)
            ...
            p1_03 = model03.coef_
            print("intersección: {:.4f}".format(p1_03[0]))

            plt.figure(3)
            plt.plot(lapsetime03,prediccion03, label="Alpt = {:.4f}t + {:.4f}".format(p1_03[0],p2_03))
            plt.plot(lapsetime03,pAlpt03, label="exponencial corregida por div geom")
            plt.plot(lapsetime03,cut_env03, label="envolvente de la coda")
            plt.xlabel("tiempo [seg]")
            plt.ylabel("amplitud corregida por div geom (Alpt)")
            plt.title("Frecuencias entre 1.5 - 2.5 Hz")
            plt.legend()   

            
            # ----------------------------
            # 04
            logAlpt04 = np.log(pAlpt04).reshape(-1)
            ...
            p2_04 = model03.intercept_
            print("intersección: {:.4f}".format(p2_04))
            p1_04 = model04.coef_
            print("intersección: {:.4f}".format(p1_04[0]))

            plt.figure(4)
            plt.plot(lapsetime04,prediccion04, label="Alpt = {:.4f}t + {:.4f}".format(p1_04[0],p2_04))
            plt.plot(lapsetime04,pAlpt04, label="exponencial corregida por div geom")
            plt.plot(lapsetime04,cut_env04, label="envolvente de la coda")
            plt.xlabel("tiempo [seg]")
            plt.ylabel("amplitud corregida por div geom (Alpt)")
            plt.title("Frecuencias entre 2.0 - 3.0 Hz")
            plt.legend() 
            
            
            # ----------------------------
            # 05
            logAlpt05 = np.log(pAlpt05).reshape(-1)
            ...
            p1_05 = model05.coef_
            print("intersección: {:.4f}".format(p1_05[0]))

            plt.figure(5)
            plt.plot(lapsetime05,prediccion05, label="Alpt = {:.4f}t + {:.4f}".format(p1_05[0],p2_05))
            plt.plot(lapsetime05,pAlpt05, label="exponencial corregida por div geom")
            plt.plot(lapsetime05,cut_env05, label="envolvente de la coda")
            plt.xlabel("tiempo [seg]")
            plt.ylabel("amplitud corregida por div geom (Alpt)")
            plt.title("Frecuencias entre 2.5 - 3.5 Hz")
            plt.legend() 
            
            
            # ----------------------------
            # 06
            logAlpt06 = np.log(pAlpt06).reshape(-1)
            ...
            p1_06 = model06.coef_
            print("intersección: {:.4f}".format(p1_06[0]))

            plt.figure(6)
            plt.plot(lapsetime06,prediccion06, label="Alpt = {:.4f}t + {:.4f}".format(p1_06[0],p2_06))
            plt.plot(lapsetime06,pAlpt06, label="exponencial corregida por div geom")
            plt.plot(lapsetime06,cut_env06, label="envolvente de la coda")
            plt.xlabel("tiempo [seg]")
            plt.ylabel("amplitud corregida por div geom (Alpt)")
            plt.title("Frecuencias entre 3.0 - 4.0 Hz")
            plt.legend() 
            
            
            # ----------------------------
            # 07
            logAlpt07 = np.log(pAlpt07).reshape(-1)
            ...
            #print("intersección: {:.4f}".format(p2_07)) FUNCIONA
            p1_07 = model07.coef_
            print("intersección: {:.4f}".format(p1_07[0]))

            plt.figure(7)
            plt.plot(lapsetime07,prediccion07, label="Alpt = {:.4f}t + {:.4f}".format(p1_07[0],p2_07))
            plt.plot(lapsetime07,pAlpt07, label="exponencial corregida por div geom")
            plt.plot(lapsetime07,cut_env07, label="envolvente de la coda")
            plt.xlabel("tiempo [seg]")
            plt.ylabel("amplitud corregida por div geom (Alpt)")
            plt.title("Frecuencias entre 3.5 - 4.5 Hz")
            plt.legend() 


            # ----------------------------
            # 08
            logAlpt08 = np.log(pAlpt08).reshape(-1)
            ...
            p1_08 = model08.coef_
            print("intersección: {:.4f}".format(p1_08[0]))

            plt.figure(8)
            plt.plot(lapsetime08,prediccion08, label="Alpt = {:.4f}t + {:.4f}".format(p1_08[0],p2_08))
            plt.plot(lapsetime08,pAlpt08, label="exponencial corregida por div geom")
            plt.plot(lapsetime08,cut_env08, label="envolvente de la coda")
            plt.xlabel("tiempo [seg]")
            plt.ylabel("amplitud corregida por div geom (Alpt)")
            plt.title("Frecuencias entre 4.0 - 5.0 Hz")
            plt.legend()
...
# el ajuste lineal
            ...
            # ajuste
            popt_01, pcov_01 = curve_fit(model_exp, lapsetime01, pAlpt01,p0_01)
            ...
            popt_02, pcov_02 = curve_fit(model_exp, lapsetime02, pAlpt02, p0_02)
            ...
            popt_03, pcov_03 = curve_fit(model_exp, lapsetime03, pAlpt03, p0_03)
            ...
            popt_04, pcov_04 = curve_fit(model_exp, lapsetime04, pAlpt04, p0_04)
            ...
            popt_05, pcov_05 = curve_fit(model_exp, lapsetime05, pAlpt05, p0_05)
            ...
            popt_06, pcov_06 = curve_fit(model_exp, lapsetime06, pAlpt06, p0_06)
            ...
            popt_07, pcov_07 = curve_fit(model_exp, lapsetime07, pAlpt07, p0_07)
            ...
            popt_08, pcov_08 = curve_fit(model_exp, lapsetime08, pAlpt08, p0_08)
